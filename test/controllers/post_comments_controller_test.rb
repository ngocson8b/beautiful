...
class PostCommentsControllerTest < ActionController::TestCase
  ...
  test "should create post_comment" do
    assert_difference('PostComment.count') do
      post :create, post_comment: { comment: @post_comment.comment, post_id: @post_comment.post_id, user_id: @post_comment.user_id }
    end
  ...
  test "should update post_comment" do
    patch :update, id: @post_comment, post_comment: { comment: @post_comment.comment, post_id: @post_comment.post_id, user_id: @post_comment.user_id }
    assert_redirected_to post_comment_path(assigns(:post_comment))
  end
